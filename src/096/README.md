...
![](https://projecteuler.net/project/images/p096_1.png) ![](https://projecteuler.net/project/images/p096_2.png)
...
The 6K text file, [sudoku.txt](/src/096/p096_sudoku.txt) (right click and 'Save Link/Target As...'), contains fifty different Su Doku puzzles ranging in difficulty, but all with unique solutions (the first puzzle in the file is the example above).
